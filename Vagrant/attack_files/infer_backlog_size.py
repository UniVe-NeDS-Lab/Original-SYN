...
def infer_backlog_size(target_ip, target_port, min_Bvalue):
    """
...
def main(target_ip, target_port, min_Bvalue):
    inferred_size = infer_backlog_size(target_ip, target_port, min_Bvalue)
...
if __name__ == "__main__":
    if len(sys.argv) != 4:
        print("Usage: python script.py <target_ip> <target_port> <min_backlog_value>")
        sys.exit(1)

    target_ip = sys.argv[1]
    target_port = int(sys.argv[2])
    min_Bvalue = int(sys.argv[3])
    main(target_ip, target_port, min_Bvalue)
